        ...
        if(tagName!=null && tagName.equalsIgnoreCase("HellerStandard/PartCounterTotal")){
            ...
            try {
                ...
                if(nd!=null && nd.get("cycleDataStartTime")==null){
                    ...
                    ((ObjectNode) nd).put("cycleDataEndTime", node.get("tagData").get(0).get("timestamp").asLong());
                    ((ObjectNode) nd).put("cycleEndDataCount", node.get("tagData").get(0).get("value").asText());
