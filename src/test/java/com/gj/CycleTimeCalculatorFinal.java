...
public class CycleTimeCalculatorFinal {
    ...
    public void processNode(JsonNode node) {
        ...
        if(tagName!=null && tagName.equalsIgnoreCase("HellerStandard/PartNumberOp")){
            ...
            deviceCycleTimes.put(deviceName+"_Program", nd.toString());
        ...
        if(tagName!=null && tagName.equalsIgnoreCase("HellerStandard/PartCounterTotal")){
            String val=deviceCycleTimes.get(deviceName+"_Cycle")== null ? "" : deviceCycleTimes.get(deviceName+"_Cycle");
            try {
                ...
                if( (nd!=null && nd.get("cycleDataStartTime")==null)){
                    ...
                    deviceCycleTimes.put(deviceName+"_Cycle", nd.toString());
                }
                else{
...
//                    }
//
//                }catch (Exception e){e.printStackTrace();}printStackTrace
                    processNode(node);
            }
            int cycles=0;
