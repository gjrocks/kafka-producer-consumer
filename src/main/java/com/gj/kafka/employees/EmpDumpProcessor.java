...
public class EmpDumpProcessor implements Processor<String,String,String,String> {
private KeyValueStore<String, String> kvStore;
private KeyValueStore<String, String> cycleStore;
private ProcessorContext<String,String> context;
private String cityName;

private static final Logger logger = LoggerFactory.getLogger(EmpDumpProcessor.class);
int count=0;
...
public void init(ProcessorContext<String, String> context) {
    ...
    cycleStore=context.getStateStore("emp-store");
