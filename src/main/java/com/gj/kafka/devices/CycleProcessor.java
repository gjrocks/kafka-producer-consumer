...
public class CycleProcessor implements Processor<String,String,String,String> {
...
//    });
    ...
    public void processNode(JsonNode node,Record<String, String> record) {
        ...
        if(tagName!=null && tagName.equalsIgnoreCase("HellerStandard/PartNumberOp")){
            ...
            this.context.forward(new Record<>(deviceName+"_Program", nd.toString(), record.timestamp()),"ChildProcess");
        ...
        if(tagName!=null && tagName.equalsIgnoreCase("HellerStandard/PartCounterTotal")){
            ...
            try {
                ...
                if( (nd!=null && nd.get("cycleDataStartTime")==null)){
                    ...
                    this.context.forward(new Record<>(deviceName+"_Cycle_Start", nd.toString(), record.timestamp()),"ChildProcess");
                    ...
                    if(cycleCount>0) {
                       ...
                       // cycleTimes.add(builder.toString());
                        ...
                        this.context.forward(new Record<>(deviceName+"_Cycle", builder.toString(), record.timestamp()),"Sink");
                        this.context.forward(new Record<>(deviceName+"_Cycle_End", builder.toString(), record.timestamp()),"ChildProcess");
                        this.context.forward(new Record<>(deviceName+"_Cycle_Start", nd.toString(), record.timestamp()),"ChildProcess");
                    }
                }
