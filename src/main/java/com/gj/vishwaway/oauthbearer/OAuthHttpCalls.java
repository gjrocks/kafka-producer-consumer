package com.gj.vishwaway.oauthbearer;
...
*/
        ...
        OAUTH_WITH_SSL=true;
        OAUTH_LOGIN_SERVER="sso-dev.johndeere.com/oauth2/ausi7trcalVAIeyFF0h7";
        OAUTH_LOGIN_ENDPOINT="/v1/token";
        OAUTH_LOGIN_GRANT_TYPE="client_credentials";
        OAUTH_LOGIN_SCOPE="mfg-dev";
        OAUTH_LOGIN_AUTHORIZATION="Basic MG9hMjRnaGkwMGs0b3A2c3AwaDg6VEstSW1IbktwTXYzUmJQRTM5bVJCdWFYV3RMSUJnSldJVm9od0xWWl9NU1ZRT3RzeHlCUFNkWFJHTXlDMTV4SA==";
        OAUTH_INTROSPECT_SERVER="sso-dev.johndeere.com/oauth2/ausi7trcalVAIeyFF0h7";
        OAUTH_INTROSPECT_ENDPOINT="/v1/introspect";
        OAUTH_INTROSPECT_AUTHORIZATION="Basic MG9hMjRnaGkwMGs0b3A2c3AwaDg6VEstSW1IbktwTXYzUmJQRTM5bVJCdWFYV3RMSUJnSldJVm9od0xWWl9NU1ZRT3RzeHlCUFNkWFJHTXlDMTV4SA==";
     ...
     //   OAUTH_INTROSPECT_ENDPOINT = (String) getPropertyValue(options, "OAUTH_INTROSPECT_ENDPOINT", "");
       ...
       // OAUTH_INTROSPECT_AUTHORIZATION = (String) getPropertyValue(options, "OAUTH_INTROSPECT_AUTHORIZATION", "");
        ...
        OAUTH_ACCEPT_UNSECURE_SERVER = false;// (Boolean) getPropertyValue(options, "OAUTH_ACCEPT_UNSECURE_SERVER", false);
        OAUTH_WITH_SSL = true;// (Boolean) getPropertyValue(options, "OAUTH_WITH_SSL", true);
    }
